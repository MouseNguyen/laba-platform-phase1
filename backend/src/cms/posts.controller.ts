...
export class PostsController {
  ...
  @ApiOperation({
    ...
    description: 'Retrieve posts with filtering, sorting, and pagination. Cached for 60s.',
  })
  @ApiOkResponse({
  ...
  async findAll(@Query() query: PostQueryDto): Promise<PaginatedPostsResponseDto> {
  ...
  @ApiOperation({
    ...
    description: 'Retrieve a specific post by its slug. Used for public blog pages.',
  })
  @ApiOkResponse({
    description: 'Post retrieved successfully',
    type: PostResponseDto,
  ...
  @ApiOperation({
    ...
    description: 'Restores a previously deleted post. Requires RESTORE permission.',
  })
  @ApiOkResponse({
