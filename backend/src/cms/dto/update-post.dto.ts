...
export class IsPublishedRequiresDateConstraint implements ValidatorConstraintInterface {
...
export class UpdatePostDto extends PartialType(CreatePostDto) {
  @ApiPropertyOptional({
    description: 'WARNING: Slug should NOT be updated after creation to avoid breaking URLs',
